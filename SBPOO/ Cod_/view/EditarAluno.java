...
public class EditarAluno extends Janela implements ActionListener {
	...
	public EditarAluno() {
		...
		lblNome.setBounds(25, 167, 47, 14);

		JLabel lblMatricula = new JLabel("Matricula:");
		lblMatricula.setBounds(15, 201, 57, 14);
		...
		lblCurso.setBounds(25, 235, 41, 14);
		...
		lblCpf.setBounds(311, 167, 34, 14);

		JLabel lblRg = new JLabel("RG:");
		lblRg.setBounds(311, 201, 34, 14);
		...
		JLabel lblEditAlunos = new JLabel("Edi\u00E7\u00E3o de Alunos");
		lblEditAlunos.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblEditAlunos.setBounds(194, 10, 140, 14);
		contentPane.add(lblEditAlunos);
		...
		for (Aluno aluno : datea.alunos) {
			Object[] fila = new Object[numCols];
			fila[0] = aluno.getNome();
			fila[1] = aluno.getMatricula();
			fila[2] = aluno.getCurso();
			fila[3] = aluno.getCpf();
			fila[4] = aluno.getRg();
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btConcluirEdicao){
			Aluno aluno = new Aluno(textField.getText(),textField_3.getText(),textField_1.getText(), textField_4.getText(),textField_2.getText());
			System.out.println(">>"+nome_temp+"<< " +aluno.getNome());
			datea.alterarAluno(nome_temp, aluno);
			nome_temp="";
